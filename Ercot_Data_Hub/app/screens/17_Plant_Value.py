...
st.title("🔆 Predicted Solar Settlement")
st.caption("Predict a plant's forward **PPA/VPPA settlement**: forecast its generation × its "
           "hub's forward price curve, then net against your strike. Set the **PPA price** "
           "below to see net settlement (＋ offtaker receives · − offtaker pays); leave it at "
           "0 to see just the **capture price** (generation-weighted price earned vs the flat "
           "ATC average).")
