...
def get_curve_for_specs(manuf, model, rotor_m=None, rated_kw=None):
    ...
    # so it runs BEFORE any coarse model-name fallback. Correctly routes modern
    # low-wind Vestas/GE machines (e.g. V110-2.0 ≈ 210 W/m²) that were previously
    # mis-mapped to the conservative GENERIC_IEC2.
