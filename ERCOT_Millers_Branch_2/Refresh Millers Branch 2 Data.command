#!/bin/bash
# Double-click to top up Millers Branch 2's generation + node prices to the latest ERCOT
...
CANDIDATES=(
  "${MILLER_HUB_ROOT:-}/.venv/bin/python"
...
if [ -z "$HUB_PY" ]; then
  ...
  echo "Set MILLER_HUB_ROOT to the Hub repo, or keep it as a sibling directory."
