#!/usr/bin/env python3
"""Top up Miller's cached data to the latest available ERCOT date — one command.
...
Advances both streams the portal settles on, into the shared Data Hub lake:
  ...
  * node price — RT15 settlement-point price at MIL_MILG1_2
...
Run it in the **Hub's** virtualenv (it has gridstatus + the ERCOT credentials):
    ...
    # or double-click "Refresh Miller Data.command"
...
def main() -> int:
    ...
    print(f"Miller ({node}) — latest available SCED date: {latest}\n")
