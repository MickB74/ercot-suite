#!/usr/bin/env python3
"""Top up Aguayo Wind's cached data to the latest available ERCOT date — one command.
...
Advances both streams the portal settles on, into the shared Data Hub lake:
  ...
  * node price — RT15 settlement-point price at AGUAYO_UNIT1
...
def main() -> int:
    ...
    print(f"Aguayo Wind ({node}) — latest available SCED date: {latest}\n")
