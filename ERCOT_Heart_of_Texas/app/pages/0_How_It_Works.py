...
from hotwind import branding, contract  # noqa: E402
...
from metered history); **Calibrated model** (a weather-typical wind profile for this plant's
coordinates and turbine fleet, rescaled to match real metered output — capturing actual
availability, curtailment and losses); or **Physical model** (raw typical year).
**Annual degradation** defaults to **0%/yr** for wind.
""")
st.markdown(
    """
