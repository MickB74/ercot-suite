#!/usr/bin/env python3
"""Top up Heart of Texas Wind's cached data to the latest available ERCOT date.
...
from hotwind import contract, hub  # noqa: E402

OVERLAP_DAYS = 5
BACKFILL_START = dt.date(2024, 1, 1)   # SCED disclosure ~2yr retention; COD 2020
...
def main() -> int:
    ...
    print(f"Heart of Texas Wind ({node}) — latest available SCED date: {latest}\n")
