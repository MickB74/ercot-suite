#!/bin/bash
# Double-click to top up Hidalgo Mirasole Wind's generation + node prices to the latest ERCOT
...
CANDIDATES=(
  "${HIDALGO_MIRASOLE_WIND_HUB_ROOT:-}/.venv/bin/python"
...
if [ -z "$HUB_PY" ]; then
  ...
  echo "Set HIDALGO_MIRASOLE_WIND_HUB_ROOT to the Hub repo, or keep it as a sibling directory."
