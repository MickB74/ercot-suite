...
so this page *estimates* it: expected generation from Hidalgo Mirasole Wind's own historical
...
basis = st.sidebar.radio(
    ...
    help="**Calibrated model** — PVWatts typical-meteorological-year shape, "
         "rescaled so it matches Hidalgo Mirasole Wind's real metered output (captures actual "
