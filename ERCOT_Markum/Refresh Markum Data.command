#!/bin/bash
# Double-click to top up Markum's generation + node prices to the latest ERCOT
...
CANDIDATES=(
  "${MARKUM_HUB_ROOT:-}/.venv/bin/python"
...
if [ -z "$HUB_PY" ]; then
  ...
  echo "Set MARKUM_HUB_ROOT to the Hub repo, or keep it as a sibling directory."
