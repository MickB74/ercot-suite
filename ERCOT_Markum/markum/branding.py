...
def eyebrow(st, text: str) -> None:
    ...
    st.markdown(f'<div class="markum-eyebrow">{text}</div>', unsafe_allow_html=True)
...
def hero(st, title: str, subtitle: str = "") -> None:
    ...
    st.markdown(
        ...
        f'<div class="eyebrow">Markum Solar · Settlement Portal</div>'
...
def footer(st) -> None:
    year = pd_year()
    st.markdown(
        f'<div class="markum-foot">Markum Solar Settlement Portal · prepared by '
