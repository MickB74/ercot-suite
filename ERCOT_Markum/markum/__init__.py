"""Markum Solar settlement portal — a focused, customer-facing view of one asset.
...
in the internal Data Hub. All this layer adds is:
  ...
  * :mod:`markum.hub`       — locate the Hub, put ``ercot_core`` on the path,
                              and read Markum's cached generation / price data.
  * :mod:`markum.contract`  — the one asset + contract definition (strike, etc.)
  * :mod:`markum.branding`  — shared look-and-feel for the customer pages.
"""
