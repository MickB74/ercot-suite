#!/bin/bash
# Double-click to top up Stafford Solar's generation + node prices to the latest ERCOT
...
CANDIDATES=(
  "${HORNET_SOLAR_HUB_ROOT:-}/.venv/bin/python"
...
if [ -z "$HUB_PY" ]; then
  ...
  echo "Set HORNET_SOLAR_HUB_ROOT to the Hub repo, or keep it as a sibling directory."
