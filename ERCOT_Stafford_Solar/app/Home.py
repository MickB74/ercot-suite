"""Stafford Solar Settlement Portal — router / entry point.

A focused, customer-facing app for one asset (Stafford Solar). It reuses the
...
nav = st.navigation({
    ...
    "Analysis": [
        st.Page("pages/8_Generation_Analysis.py", title="Generation Analysis", icon="⚡"),
        st.Page("pages/9_Capture_Analysis.py", title="Capture Analysis", icon="🎯"),
    ],
    "Data": [
